...
function Curriculum() {
  ...
  return (
    <div id="curriculum" className="w-full px-4 py-12 md:py-24 lg:py-16 xl:py-24 md:px-8 lg:px-12 xl:px-16 2xl:px-[30rem] bg-secondary flex justify-center items-center">
